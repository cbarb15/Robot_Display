...
osThreadId_t ButtonInterruptTaskHandle;
const osThreadAttr_t ButtonInterruptTask_attributes = {
  .name = "ButtonInterruptTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* USER CODE BEGIN PV */
...
//  messageQueueHandle = osMessageQueueNew (8, sizeof(uint8_t), &messageQueue_attributes);
  /* USER CODE END RTOS_QUEUES */

  ButtonInterruptTaskHandle = osThreadNew(Button_Interrupt_Task, NULL, &ButtonInterruptTask_attributes);
